...
public class EnemyFOV : MonoBehaviour
{
    ...
    {
        //로컬 좌표게 기준으로 설정하기 위해 적 캐릭터의 Y회전값을 더함
    ...
    public bool isTracePlayer()
    {
        ...
        if(colls.Length==1)
        {
            //적 캐릭터와 주인공 사이의 방향 벡터 계산
            Vector3 dir = (playerTr.position - enemyTr.position).normalized;

            //적캐릭터의 시야각에 들어왔는지를 판단
            //Vector3.Angle(from,to)-> form벡터와 to벡터 사잇각을 오일러각으로 반환
    ...
    //추적반경과 시야각에 주인공이 들어왔을 때 적 캐릭터와 플레이어 사이에 장애물이 있는 지 확인하는 함수
