...
public class EnemyFire : MonoBehaviour
{
    ...
    private void Fire()
    {
        ...
        if (isReload) StartCoroutine(Reloading());
    }
    ...
    IEnumerator ShowMuzzleFlash()
    {
        ...
        //다른 게임오브젝트 아래에 차일드화된 게임오브젝트는 좌표, 회전각도, 스케일을 수정하려면 반드시 local~ 속성을 사용해야 함
