...
public class BarrelCtrl : MonoBehaviour
{
    ...
    {
        //폭발 효과 프리팹을 동적으로 생성
        //Quaternion.identity: 특정 회전값없이 생성하려는 프리팹 또는 3D 모델의 원래 회전 각도로 적용
    ...
    {
        //주변에 있는 드럼통을 모두 추출
        Collider[] colls = Physics.OverlapSphere(pos, expRadius, 1 << 11); //11번째 레이어
