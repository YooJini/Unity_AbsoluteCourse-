...
public class DataManager : MonoBehaviour
{
    ...
    public void Save(GameData gameData)
    {
        ...
        //BinaryFormatter를 사용해 객체 직렬화 한다.
        //객체직렬화: 객체를 통신이나 파일 또는 메모리에 저장하기 위해 일련의 바이트로 변환하는 것
        //즉 메모리 상에 흩어져 저장된 데이터를 일렬로 재배열해 전송하기에 용이한 데이터로 바꾸는 것
        ...
        bf.Serialize(file, data);       //Serialize(): 객체를 직렬화하는 함수 (파일에 쓸 때 사용)
        file.Close();
    }
